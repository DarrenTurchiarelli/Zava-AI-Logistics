...
for the DT Logistics parcel tracking system.
...
async def generate_test_data(num_parcels: int = 30, num_approvals: int = 10):
    ...
    """
    print("=" * 60)
    print("DT Logistics - Test Data Generator")
    print("=" * 60)
    ...
    try:
        async with ParcelTrackingDB() as db:
            ...
            print(f"   Total DCs used: {len([dc for dc in dc_count.keys() if dc not in ['Unknown DC', 'To Be Advised', 'Completed']])}")
...
async def main():
    ...
    print("\n" + "=" * 60)
    print("DT LOGISTICS - SAMPLE DATA GENERATOR")
    print("=" * 60)
