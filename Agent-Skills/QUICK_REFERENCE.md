...
```python
from agents.prompt_loader import validate_all_agents
...
```python
from agents.prompt_loader import reload_prompts
...
python agents/prompt_loader.py

# Test importing in your code
python -c "from agents.base import customer_service_agent; print('✓ OK')"

# Test a specific agent
python -c "from agents.prompt_loader import get_agent_prompt; print(get_agent_prompt('dispatcher')[:100])"
```
...
# Test specific agent
python -c "from agents.prompt_loader import get_agent_prompt; print(get_agent_prompt('customer-service'))"

# List all agents
python -c "from agents.prompt_loader import list_available_agents; print(list_available_agents())"

# Validate and get details
python -c "from agents.prompt_loader import validate_all_agents; import json; print(json.dumps(validate_all_agents(), indent=2))"
```
