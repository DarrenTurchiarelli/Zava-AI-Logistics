"""
DT Logistics - Parcel Management Module
...
@dataclass
class Parcel:
    """Represents a parcel in the DT Logistics system"""
    tracking_number: str
    sender_name: str
    sender_address: str
    sender_phone: str
...
def get_parcel_info(parcel: Parcel) -> str:
    ...
    info = f"""
DT Logistics Parcel Information
================================
...
if __name__ == "__main__":
    print("DT Logistics - Parcel Management Module")
    print("=" * 50)
