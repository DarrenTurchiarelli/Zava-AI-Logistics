"""
Zava - Create Single Azure AI Foundry Agent
...
def create_parcel_intake_agent():
    ...
    try:
        ...
        instructions = """
You are a Parcel Intake Agent for Zava, Australia's leading last-mile delivery service.
...
"""
        ...
        agent = project_client.agents.create_agent(
            model="gpt-4o", name="Parcel Intake Agent", instructions=instructions, tools=[{"type": "code_interpreter"}]
        )
...
Sender: Zava Warehouse Melbourne
...
"""
        ...
        # Send message
        message = project_client.agents.create_message(thread_id=thread.id, role="user", content=test_message)
...
if __name__ == "__main__":
    print("Zava - Azure AI Foundry Agent Creation")
    print("=" * 70)
