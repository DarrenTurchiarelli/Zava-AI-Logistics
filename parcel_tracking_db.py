        ...
        containers = [
            ...
            },
            {
                ...
                "indexing_policy": {
                    ...
                    "automatic": True,
                    "includedPaths": [{"path": "/*"}],
                    # Composite index enables ORDER BY on cross-partition queries
                    # without it Cosmos throws a 400 and the query returns nothing
                    "compositeIndexes": [
                        [
                            {"path": "/manifest_date", "order": "descending"},
