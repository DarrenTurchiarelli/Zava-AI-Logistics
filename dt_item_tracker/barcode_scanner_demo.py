#!/usr/bin/env python3
"""
Barcode Scanner Simulation for Approval Workflow System

This script simulates the barcode scanning process for packages/items
...
class BarcodeScannerSimulator:
    ...
    def simulate_barcode_scan(self) -> str:
    ...
    def get_item_details(self) -> Dict[str, str]:
        ...
        addresses = [
            ...
            "147 Broadway, Boston, MA 02101",
            "258 Market St, San Francisco, CA 94102"
        ]
    ...
    def scan_and_add_item(self) -> Dict:
        ...
        print("\n" + "="*60)
        print("🔍 STARTING BARCODE SCAN PROCESS")
        print("="*60)
        
        # Step 1: Scan barcode
        barcode = self.simulate_barcode_scan()
...
def interactive_demo():
    ...
    scanner = BarcodeScannerSimulator()
    
    print("\n🚀 BARCODE SCANNER SIMULATION DEMO")
    print("Welcome to the Package Processing System!")
    
    while True:
        print("\n📋 MENU OPTIONS:")
        print("1. 📱 Scan new item")
