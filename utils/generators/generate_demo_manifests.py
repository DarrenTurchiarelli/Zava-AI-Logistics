...
Note: Use 'python' instead of 'py' launcher - Faker env may not be picked up with py
"""
...
if __name__ == "__main__":
    ...
    elif args.large_default:
        # Generate large manifest with default 120 parcels
        asyncio.run(generate_large_manifest(120))
    else:
        # Generate regular demo manifests
        asyncio.run(main())
