...
async def generate_dispatcher_demo_parcels():
    ...
    async with ParcelTrackingDB() as db:
        ...
        dates_to_generate = [(today, "Today"), (tomorrow, "Tomorrow")]
        ...
        for target_date, date_label in dates_to_generate:
            ...
            parcel_distributions = {"Sydney": 20, "Melbourne": 15, "Brisbane": 10, "Adelaide": 5}
